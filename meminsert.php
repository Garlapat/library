...
if(isset($_POST['done'])){
    ...
    $sql = "INSERT INTO `member` VALUES($id,'$name','$addr','$mobileno','$email')";
                ...
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
                    <form class="login100-form validate-form" action="" method="post">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="email" placeholder="Enter Member id" name="id">
                          </div>
                          <div class="col">
                        ...
                        <div class="container-login100-form-btn m-t-20">
                            <input type="submit" value="ADD" class="login100-form-btn" name="done">
                            </input>
                        </div>
